"""Open-Meteo Weather API ingestor.

Fetches hourly + daily weather forecast (fallback for OpenWeather).
"""
...
class OpenMeteoWeatherIngestor(BaseIngestor):
    """Ingestor for Open-Meteo Weather API."""
    
    BASE_URL = "https://api.open-meteo.com/v1/forecast"
    
    def __init__(self, db_conn: psycopg2.extensions.connection):
        """Initialize Open-Meteo Weather ingestor."""
        super().__init__(
            db_conn=db_conn,
    ...
    def fetch_data(
        ...
        # Request fields that OpenWeather might not have
        hourly_vars = [
            "temperature_2m", "relative_humidity_2m", "precipitation",
            "wind_speed_10m", "wind_direction_10m", "wind_gusts_10m",
            "pressure_msl", "cloud_cover", "shortwave_radiation",
    ...
    def ingest_location(
        ...
        logger.info(f"Ingesting Open-Meteo Weather for location {location_id}...")
